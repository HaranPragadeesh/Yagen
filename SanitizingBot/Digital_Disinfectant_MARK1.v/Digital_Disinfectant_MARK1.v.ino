...
//            Serial.print(obs2);
            ...
            //EXTREMES & LATER EXTREMES
              ...
              Drive('L',MotorSpeed+3); // Left
              
            } else if (pos == -2){
              Drive('R',MotorSpeed+3);// Right
              
            }
            else if (pos == 1){
              Drive('L',MotorSpeed+1); // Left
            }else if (pos == -1){
              Drive('R',MotorSpeed+1); // Right
            }
           
            //To get back to the line when missed
...
int DreadSensorVal(){
  ...
  LFSensor[5] = digitalRead(S6);

  int currpos = 0;
  
  //EXTREMES
   
  if((LFSensor[0]== 0 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 1 )||(LFSensor[3]== 1 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 0))  {currpos = 0;}
  else if((LFSensor[0]== 0 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 1)&&(LFSensor[5]== 0))  {currpos = 1;}
  
  else if((LFSensor[0]== 0 )&&(LFSensor[1]== 1 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 0))  {currpos = -1;}
  else if((LFSensor[0]== 0 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 1))  {currpos = 2;}
  
  else if((LFSensor[0]== 1 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 0))  {currpos = -2;}
  
  else if((LFSensor[0]== 1 )&&(LFSensor[1]== 1 )&&(LFSensor[2]== 1 )&&(LFSensor[3]== 1 )&&(LFSensor[4]== 1)&&(LFSensor[5]== 1))  {currpos = 5;}
  else if((LFSensor[0]== 0 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 0))  {currpos = 5;}
   ...
   Serial.print("     ");
   Serial.print (LFSensor[4]);
   Serial.print("     ");
   Serial.print (LFSensor[5]);
   Serial.print("     ");
