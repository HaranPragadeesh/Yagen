...
//            Serial.print(obs2);
            ...
            //EXTREMES & LATER EXTREMES
              ...
              Move(MotorSpeed, MotorSpeed-3); // Left
            }else if (pos == -1){
              Move(MotorSpeed-3, MotorSpeed); // Right
            }
            else if(pos == 2){
              Move(MotorSpeed, MotorSpeed-5); // Left
              PrevPos = 2;
            } else if (pos == -2){
              Move(MotorSpeed-5, MotorSpeed);// Right
              PrevPos = -2;
            }
...
int DreadSensorVal(){
  ...
  else if((LFSensor[0]== 0 )&&(LFSensor[1]== 0 )&&(LFSensor[2]== 0 )&&(LFSensor[3]== 0 )&&(LFSensor[4]== 0)&&(LFSensor[5]== 0))  {currpos = 4;}
